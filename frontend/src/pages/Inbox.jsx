...
const s = {
  ...
  messageHeader: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '0.75rem', marginBottom: '0.45rem', width: '100%' },
  messageSender: { fontSize: '0.78rem', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.05em' },
  messageActionRow: { display: 'flex', flexWrap: 'wrap', gap: '0.45rem', marginBottom: '0.75rem' },
  messageActionBtn: { display: 'inline-flex', alignItems: 'center', gap: '0.35rem', borderRadius: '999px', padding: '0.34rem 0.65rem', cursor: 'pointer', fontSize: '0.74rem', fontWeight: 800, letterSpacing: '0.01em', lineHeight: 1, boxShadow: 'inset 0 0 0 1px rgba(255,255,255,0.02)' },
  messageActionBtnDanger: { display: 'inline-flex', alignItems: 'center', gap: '0.35rem', borderRadius: '999px', padding: '0.34rem 0.65rem', cursor: 'pointer', fontSize: '0.74rem', fontWeight: 800, letterSpacing: '0.01em', lineHeight: 1, color: '#fff', background: 'rgba(229,62,62,0.92)', border: '1px solid rgba(255,255,255,0.08)' },
  messageText: {
    whiteSpace: 'pre-wrap',
  ...
  composerHint: { minHeight: '36px', padding: '0 0.8rem', borderRadius: '14px', border: '1px dashed rgba(212,175,55,0.24)', background: 'rgba(212,175,55,0.06)', color: 'var(--text-muted)', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: '0.45rem', fontSize: '0.72rem', fontWeight: 700, whiteSpace: 'nowrap' },
