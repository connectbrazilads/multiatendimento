...
const s = {
  ...
  messageHeader: { display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '0.75rem', marginBottom: '0.6rem', width: '100%' },
  messageSender: { fontSize: '0.76rem', fontWeight: 800, letterSpacing: '-0.01em' },
  messageHeaderSide: { display: 'flex', alignItems: 'center', gap: '0.15rem', marginLeft: 'auto', flexShrink: 0 },
  messageHeaderTime: { fontSize: '0.78rem', color: '#8a8a8a', fontWeight: 500 },
  messageMenuRoot: { position: 'relative' },
  messageMenuTrigger: { width: '26px', height: '26px', borderRadius: '8px', border: 'none', background: 'transparent', color: '#8a8a8a', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center' },
