...
export const inboxStyles = {
  ...
  chatHeader: { display: 'flex', alignItems: 'center', gap: '1rem', padding: '1rem 1.5rem', background: 'rgba(9, 9, 11, 0.88)', backdropFilter: 'blur(10px)', borderBottom: '1px solid var(--border-color)', zIndex: 10, width: '100%', boxSizing: 'border-box', minHeight: '76px' },
  ...
  chatMetaText: { fontSize: '0.76rem', color: 'var(--text-muted)', fontWeight: 700, padding: '0.2rem 0.55rem', background: 'rgba(255,255,255,0.03)', borderRadius: '999px', border: '1px solid rgba(255,255,255,0.04)' },
