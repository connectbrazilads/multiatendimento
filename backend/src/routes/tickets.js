...
const { list, getMessages, assign, resolve, update, sendMessage, sendMediaMessage, reopen, summarize, deleteMessage, spellCheck, linkContact, forwardMessage } = require('../controllers/ticketController');
