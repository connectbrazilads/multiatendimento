    ...
    <div className="sales-page">
      <header className="sales-navbar">
        ...
        <div className="sales-nav-actions">
          ...
          <a className="sales-link-btn" href="https://app.printwayy.com/Account/Login" target="_blank" rel="noreferrer">Central de Atendimento</a>
      ...
      {mobileMenuOpen ? (
        <div className="sales-mobile-panel">
          ...
          <div className="sales-mobile-links">
            ...
            <a href="https://app.printwayy.com/Account/Login" target="_blank" rel="noreferrer">Central de Atendimento</a>
